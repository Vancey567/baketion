...
function initRoutes(app) {
    ...
    // app.get('/product/productDetails/:id', orderController().show) // This :id will take you to the specific product whose id is this.id. And this id should be same as you pass it from show method
}
